    ...
    CMainParams() {
		...
		*/
		...
		checkpointData = (CCheckpointData) {
            ...
            ( 956870, uint256S("0x00007c8ac7eb36ffae4b6c9fb37ebee0465dccb43299f94ca56b49f964f5073a")),

			1581509420,     // * UNIX timestamp of last checkpoint block
			2070641,         // * total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams() {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_ALFHEIMR].nActivationHeight = 17500;
        consensus.vUpgrades[Consensus::UPGRADE_ALFHEIMR].nProtocolVersion = 175018;
		
        consensus.nMasternodePaymentsStartBlock = 17500;
