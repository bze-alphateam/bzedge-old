...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bzedge bzedge-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bzedge-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bzedge transaction") + "\n" +
              "  bzedge-tx [options] -create [commands]   " + _("Create hex-encoded bzedge transaction") + "\n" +
              "\n";
