...
public:
    ...
    int InitialiseStateEx(eh_HashState& base_state, uint32_t block_time);
#ifdef ENABLE_MINING
...
#define EhInitialiseStateEx(n, k, base_state, block_time)  \
    if (n == 96 && k == 3) {                 \
        Eh96_3.InitialiseStateEx(base_state, block_time);  \
    } else if (n == 144 && k == 5) {         \
        Eh144_5.InitialiseStateEx(base_state, block_time); \
    } else if (n == 192 && k == 7) {         \
        Eh192_7.InitialiseStateEx(base_state, block_time); \
    } else if (n == 200 && k == 9) {         \
        Eh200_9.InitialiseStateEx(base_state, block_time); \
    } else if (n == 96 && k == 5) {          \
        Eh96_5.InitialiseStateEx(base_state, block_time);  \
    } else if (n == 48 && k == 5) {          \
        Eh48_5.InitialiseStateEx(base_state, block_time);  \
    } else {                                 \
        throw std::invalid_argument("Unsupported Equihash parameters"); \
    }
