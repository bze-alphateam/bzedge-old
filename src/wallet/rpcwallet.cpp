...
UniValue z_getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    std::string defaultType = NetworkUpgradeActive(chainActive.Height(), Params().GetConsensus(), Consensus::UPGRADE_SAPLING) ? ADDR_TYPE_SAPLING : ADDR_TYPE_SPROUT;
...
UniValue z_mergetoaddress(const UniValue& params, bool fHelp)
{
    ...
    auto fEnableMergeToAddress = true; // unleash the beast
